...
const ForexHeatmapWidget: React.FC<ForexHeatmapWidgetProps> = ({ tvWidgetBaseStyle, WIDGET_CONTAINER_CLASS }) => {
  ...
  return (
    <iframe
      key="forex-heatmap-iframe"
      srcDoc={srcDoc}
      title="TradingView Forex Heatmap"
